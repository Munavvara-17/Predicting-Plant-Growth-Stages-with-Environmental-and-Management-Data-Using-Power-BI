...
To identify trends and correlations among soil, temperature, humidity, and crop performance.
...
Growth_Milestone	Growth performance index or milestone (%)
...
Soil Type Impact:
Loamy soil shows the highest average growth performance compared to other types.

Correlation Insights:
Positive correlation observed between temperature and growth milestone up to an optimal threshold.
